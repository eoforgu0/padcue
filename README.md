...
| ケーブル | データ通信できる **Type-A ― Type-C** を1本(マイコンには付属しません)。**ふだんはマイコンとドックをつないだまま**にします。最初の書き込みのときだけ PC へ挿し替え、以後 PC とは無線でやりとりします |
...
# 手順書(docs/runbook.md)のとおりに操作して、ずれていないか確認する
